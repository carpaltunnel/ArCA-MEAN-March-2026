# **Arkansas Coding Academy - Full Stack Development with Mongo, Express, Angular, and Node.JS**
## **Course Description**
...
### **Node.js**
To make use of powerful recent additions to Node.js, this course will require v22.0 or newer.  I suggest the latest LTS (Long Term Support) version which is v24 at the time of this update.  You can find the appropriate install package for your operating system on the [Node.js Download Page](https://nodejs.org/en/download/).  Older versions can be found in the [archives](https://nodejs.org/dist/) if needed.  We'll be coding in the ES6/ES2015+ format but comparisons to older versions will be presented for historical context since you will come across them in the wild.

### **Development Environment (IDE)**
Any text editor can be used for Node.js development but an IDE will make everything easier.  [Visual Studio Code](https://code.visualstudio.com/Download) is recommended because it is free, open source, extremely powerful/flexible, and will run on most modern operating systems.  There are many [keyboard shortcuts](https://code.visualstudio.com/shortcuts/keyboard-shortcuts-windows.pdf) than can improve the user experience.  [Theia IDE](https://theia-ide.org/) is extremely similar to VS Code and also recommended but we'll be using VS Code for this course due to its widespread use.


### **MongoDB**
MongoDB v7 or newer will be used for this course - install the latest LTS version for your computer.  The Community version is free and can be found on the [MongoDB Download Page](https://www.mongodb.com/try/download/community).  [Mongo Compass](https://www.mongodb.com/products/tools/compass) is a great, free, UI for interacting with your database.

### **Git**
Source control will be managed by [Git](https://git-scm.com/) and references will be provided on Github - the class git repository will be shared in Slack.  All required git functionality can be completed using only the command line but GUIs such as [GitKraken](https://www.gitkraken.com/), [SourceTree](https://www.sourcetreeapp.com/), [GitHub Desktop](https://desktop.github.com/) and others are available.  They are not required since Git functionality is built into VS Code and we will mostly use this or the terminal.

## Course Repository Structure
The could git repository is structured with directories for each lesson in *###-Title* format.  In each directory you will find a `README.md` in Markdown format that will cover the lesson topics at a high level.  These READMEs are helpful for getting a general idea what we'll discuss in each lesson, as well as a quick reference in the future.  You'll also find a *slides* directory that will contain effectively the same content as the README but in a presentation format.  We'll use the presentation during class to ensure we stay on topic, don't miss any important points, and provide the information in an easier to digest visual format.
