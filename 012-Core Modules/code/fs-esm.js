// NOTE : This will throw an error if executed on its own, more on that later.
// The error is : SyntaxError: Cannot use import statement outside a module

// Import the entire fs module
import fs from 'fs';

// Alternatively (and a superior option), import only the functions we need :
// import { existsSync, writeFileSync, readFileSync, readdirSync, truncateSync, statSync, renameSync } from 'fs';
