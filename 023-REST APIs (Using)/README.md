...
## REST Client
I'll be using [Bruno](https://www.usebruno.com/) for this lesson and highly recommend it.  Choose any client you're comfortable with, the basics will be the same in all of them.  But, I do not recommend Postman (anymore).
