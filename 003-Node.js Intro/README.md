...
3.  [Set](https://www.w3schools.com/js/js_sets.asp) - Collection of UNIQUE **values** (no keys) where each value can occur only once.  Great for deduplicating arrays!
4.  [Map](https://www.w3schools.com/js/js_maps.asp) - Collection of keyed data items.  **KEYS** can be _ANY_ (supported) type.  Similar to dictionaries in other languages. 
